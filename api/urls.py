...
urlpatterns = [
    ...
    #saved search
    path('saved_search/<id>',views.saved_searchh),
    #happycouples
    ...
    path('all_provider_ads/<id>',views.adprovider_ads),
    path('all_distributor_ads/<id>',views.addistributor_ads),
    ...
    path("profile_finder_notification/<id>",views.profile_finder_notification),
    path("related_list/<id>",views.related_list),
...
#superadmin
    ...
    # path('superadmin/emra_coin_country/<id>',super_views.emra_coin_country),
...
#//////////sales manager///////////
    ...
    path('sm_coin_commision/<id>',sm_views_api.coin_commision),
...
#//////////ad provider///////////
    ...
    path('ad_pro_update_coin_value/<id>',ad_pro_views.update_coin_value),
    ...
    path('ad_pro_emera_coin/<id>',ad_pro_views.ad_pro_emera_coin),
    path('ad_pro_amount/<id>',ad_pro_views.ad_pro_amount),
...
#//////////ad distributor///////////
    ...
    path('ad_dis_update_coin_value/<id>',ad_dis_views.update_coin_value) ,
    ...
    path('ad_dis_emera_coin/<id>',ad_dis_views.ad_dis_emera_coin),
...
#///////hiring manager//////
    ...
    path('oldform/<id>',hm_views.oldform),
