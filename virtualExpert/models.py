...
class hiringmanager(models.Model):
    ...
    personal_country = models.TextField(null=True)
    personal_city = models.TextField(null=True)
    personal_dob = models.TextField(null=True)
    personal_age = models.TextField(null=True)
    ...
    id_card = models.TextField(null=True)
    #new qualification
    aadhaar_no = models.TextField(null=True)
    aadhaar_card = models.TextField(null=True)
    pan_no = models.TextField(null=True)
    pan_card = models.TextField(null=True)
    drive_licence_no = models.TextField(null=True)
    drive_licence = models.TextField(null=True)
    drive_licence_date = models.TextField(null=True)
    licence_state = models.TextField(null=True)
    
    past_applied_date = models.TextField(null=True)
    past_applied_position = models.TextField(null=True)
    # citizen_country = models.TextField(null=True)
    govtjob_start_date = models.TextField(null=True)
    govtjob_end_date = models.TextField(null=True)
    judgment_felony = models.TextField(null=True)
    notary_lic_no =  models.TextField(null=True)
    notary_issued = models.TextField(null=True)
    notary_state = models.TextField(null=True)

    level_education = models.TextField(null=True)
    field_study = models.TextField(null=True)
    school_colege = models.TextField(null=True)
    completed_year = models.TextField(null=True)
    study_location = models.TextField(null=True)
    degree_cer = models.TextField(null=True)
    skills = models.TextField(null=True)

    work_job_title = models.TextField(null=True)
    work_company_name = models.TextField(null=True)
    work_start_date = models.TextField(null=True)
    starting_salary = models.TextField(null=True)
    work_end_date = models.TextField(null=True)
    final_salary = models.TextField(null=True)
    reason_leaving = models.TextField(null=True)
    work_review_y = models.TextField(null=True)
    expr_certi = models.TextField(null=True)
    # work_job_location = models.TextField(null=True)
    curent_busines = models.TextField(null=True)
    past_business = models.TextField(null=True)
    
    mariyo_work_type = models.TextField(null=True)
    company_name = models.TextField(null=True)
    company_address = models.TextField(null=True)
    company_phone = models.TextField(null=True)
    company_email = models.TextField(null=True)
