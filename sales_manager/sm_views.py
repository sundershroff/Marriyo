...
def signup(request):
    ...
    if request.method == "POST":
        if request.POST['password'] == request.POST['confirm_password']:
            ...
            response = requests.post("http://51.20.61.70:3000/sm_signup/",data=data)
...
def signin(request):
    ...
    if request.method == "POST":
        ...
        response = requests.post("http://51.20.61.70:3000/sm_signin/",data=request.POST)
#        print(response.status_code)
 #       print(type(jsondec.decode(response.text)))
  #      print(jsondec.decode(response.text))
        ...
        try:
            ...
            uid = uidd
        if response.status_code == 200:
            mydata = requests.get(f"http://51.20.61.70:3000/sm_my_data/{uid}").json()[0]
            ...
            if user_otp is not None:
                ...
                delete_hm = requests.delete("http://51.20.61.70:3000/sm_delete_data/",data=request.POST)
...
def otp(request,id):
    ...
    if request.method == "POST":
        ...
        response = requests.post(f"http://51.20.61.70:3000/sm_otp/{id}", data=data)
...
def profile_picture(request,id):
    if request.method == "POST":
        ...
        response = requests.post(f"http://51.20.61.70:3000/sm_profile_picture/{id}",   files=request.FILES)
        print(response)
        print(response.status_code)
        print(response.text)
        uidd = (response.text[1:-1])
...
def upload_acc(request,id):
    try:
        #hiring manager list
        hiring_manager = requests.get("http://51.20.61.70:3000/all_hm_data/").json()
        neww=[]
        response = requests.get('https://api.first.org/data/v1/countries').json()
        all = requests.get('https://countriesnow.space/api/v0.1/countries/states').json()
        states = json.dumps(all["data"])
        ...
        if request.method == "POST":
            ...
            print(dictio)
            # response = requests.post(f"http://54.159.186.219:8000/profileidcard/{id}",   files=request.FILES)
            response = requests.post(f"http://51.20.61.70:3000/sm_upload_account/{id}",   data = dictio,files=request.FILES)
            print(response)
            print(response.status_code)
            print(response.text)
            uidd = (response.text[1:-1])
...
def admin_dashboard(request,id):
    ...
    try:
        ...
        mydata = requests.get(f"http://51.20.61.70:3000/sm_my_data/{id}").json()[0]
        print(mydata)
        #Notification
        if requests.get(f"http://51.20.61.70:3000/notification_data/{id}") == None:
            notification=""
            
        else:
            notification = requests.get(f"http://51.20.61.70:3000/notification_data/{id}")
            notification_data = json.loads(notification.text)
        all_profile_finder = requests.get("http://51.20.61.70:3000/alluserdata/").json()
        all_client_data=requests.get("http://51.20.61.70:3000/all_client_data/").json()

        allads=requests.get("http://51.20.61.70:3000/adprovider_ads/").json()
        # addistributor
        alldis_ads=requests.get("http://51.20.61.70:3000/addistributor_ads/").json()
        sm_adss=[]
        new1=[]
        new=[]
        ads_count=[]
        ...
        c=[]
        mydata = requests.get(f"http://51.20.61.70:3000/single_users_data/{id}").json()[0]
        print(mydata)
        #Notification
        if requests.get(f"http://51.20.61.70:3000/notification_data/{id}") == None:
            notification=""
...
def edit_profile(request,id):
        ...
        try:
            ...
            if request.method=="POST":
                print(request.POST)
                response = requests.post(f"http://51.20.61.70:3000/sm_edit_data/{id}", data = request.POST,files=request.FILES)
                print(response)
                print(response.status_code)
                print(response.text)
...
def hand_list(request,id):
    ...
    try:
        error = ""
        mydata = requests.get(f"http://51.20.61.70:3000/sm_my_data/{id}").json()[0]
        my_user = requests.get(f"http://51.20.61.70:3000/sm_my_users_data/{id}").json()
        print(my_user)
        access = ""
        idd = id
    except:
        ...
        mydata = requests.get(f"http://51.20.61.70:3000/single_users_data/{id}").json()[0]  
        print(mydata)
        my_user = requests.get(f"http://51.20.61.70:3000/sm_my_users_data/{mydata['aid']}").json()
        print(my_user)
        access = mydata['access_Privileges']
        idd = mydata['aid']
    jsondec = json.decoder.JSONDecoder()
    ...
    if request.method == "POST":
        ...
        if 'view_client' in request.POST:
            ...
            print(data)
            response = requests.post(f"http://51.20.61.70:3000/client_otp_active/{a}", data=data)
            print(response.status_code)
            if response.status_code == 200:
                activate=requests.post(f"http://51.20.61.70:3000/active_satus/{a}")
                print(activate)
            ...
            response = requests.post(f"http://51.20.61.70:3000/add_client_data/{idd}", data =data,files=request.FILES)
...
def otp_client(request,id):
    ...
    if request.method == "POST":
        ...
        print(data)
        response = requests.post(f"http://51.20.61.70:3000/client_otp/{idd}", data=data)
...
def ads_list(request,id):
    ...
    jsondec = json.decoder.JSONDecoder()
    c=[]
    client_activities=requests.get("http://51.20.61.70:3000/all_activities/").json()
    all_client_data= requests.get("http://51.20.61.70:3000/all_client_data/").json()
    ...
    if request.method == "POST":
        if 'semail' in request.POST:
            ...
            response=requests.post(f"http://51.20.61.70:3000/sendmail/{request.POST['semail']}",data=request.POST)
            if response.status_code == 200:
            ...
            response = requests.post(f"http://51.20.61.70:3000/add_client_activities/{request.POST['client_name']}", data =data)
            print(response.status_code)
            return redirect(f"/sales_manager/sm_ads_list/{id}")
...
def sm_client_details(request,id):
    ...
    print(uid_client)
    client_data=requests.get(f"http://51.20.61.70:3000/view_client_id/{uid_client}").json()
    print(client_data)
    context={
...
def ad_details(request,id):
    ...
    viewid=requests.get(f"http://51.20.61.70:3000/view_adpro_id/{uid_view}").json()
    ads_data=requests.get("http://51.20.61.70:3000/adprovider_ads/").json()
...
def edit_adpro_details(request,id):
    ...
    adspro=requests.get(f"http://51.20.61.70:3000/addpro_ads_id/{adprolist_id}").json()

    
    if 'approve' in request.POST:
        # print(request.POST['approve'])
        response=requests.post(f"http://51.20.61.70:3000/adspro_status_active/{request.POST['approve']}",data=request.POST)
        return redirect(f"/sales_manager/sm_ad_details/{id}")
    if "adpro_reject" in request.POST:
        print(request.POST['adpro_reject'])
        response=requests.post(f"http://51.20.61.70:3000/adspro_status_reject/{request.POST['adpro_reject']}",data=request.POST)
        return redirect(f"/sales_manager/sm_ad_details/{id}")
...
def ad_dis_details(request,id):
    ...
    ad_pro_ads(request,id)
    # print(uid_dis)
    view_id=requests.get(f"http://51.20.61.70:3000/view_addis_id/{uid_dis}").json()
    ad_dis_ads=requests.get("http://51.20.61.70:3000/addistributor_ads/").json()
...
def edit_ad_details(request,id):
    ...
    ads=requests.get(f"http://51.20.61.70:3000/addis_ads_id/{addlist_id}").json()

    if 'approve_dis' in request.POST:
        print(request.POST['approve_dis'])
        response=requests.post(f"http://51.20.61.70:3000/adsdis_status_active/{request.POST['approve_dis']}",data=request.POST)
        return redirect(f"/sales_manager/sm_ad_dis_details/{id}")
    if 'addis_reject' in request.POST:
        # print(request.POST['addis_reject'])
        response=requests.post(f"http://51.20.61.70:3000/adsdis_status_reject/{request.POST['addis_reject']}",data=request.POST)
        print(response)
        return redirect(f"/sales_manager/sm_ad_dis_details/{id}")
...
def users(request,id):
    ...
    if request.method== "POST":
        ...
        if "delete" in request.POST:
            response = requests.post(f"http://51.20.61.70:3000/sm_add_user/{id}",data=request.POST)
            print(response.text)
            print(response.status_code)
            ...
            print(data)
            response = requests.post(f"http://51.20.61.70:3000/sm_add_user/{id}",data=data)
            # print(response.text)
            # print(response.status_code)
            if response.status_code == 200:
...
def add_users(request,id):
    ...
    try:
        ...
        if request.method=="POST":
            ...
            print(response.status_code)
            if response.status_code == 200:
                return redirect(f"http://51.20.61.70:3000/sales_manager/sm_users/{id}")
            elif response.status_code == 203:
                print("user already exist")
                error = "User Already Exixts"
...
def sm_user_edit(request,id):
    ...
    try:
        mydata = requests.get(f"http://51.20.61.70:3000/sm_my_data/{id}").json()[0]
        sm_my_users_data   = requests.get(f"http://51.20.61.70:3000/single_users_data/{user_uid}").json()[0]
...
def setting(request,id):
    ...
    if request.method=="POST":
        ...
        if 'pass_reset' in request.POST:
            ...
            response = requests.post(f"http://51.20.61.70:3000/password_reset/{id}",data=request.POST )
        else:
            # print(request.POST)
            response = requests.post(f"http://51.20.61.70:3000/sm_email_update/{id}", data = request.POST)
            print(response)
            print(response.status_code)
            print(response.text)
   ...
   # else:
    ...
    if request.method=="POST":
        ...
        if request.POST['password'] == request.POST['confirm_password']:
            ...
            response = requests.post(f"http://51.20.61.70:3000/pass_sales_update/{id}",data=request.POST )
...
def ad_pro_ads(request,id):
    ...
    try:
        ...
        access = mydata['access_Privileges']
        idd = mydata['aid']
    all_data=requests.get("http://51.20.61.70:3000/ad_pro_list/").json()
    ad_data=requests.get("http://51.20.61.70:3000/ad_dis_list/").json()
    # print(all_data)
    new=[]
    clients=[]
    for i in all_data:
  ...
  #      print(value)
   ...
   # else:
    ...
    if request.method == "POST":
        ...
        print(request.POST)
        response = requests.post("http://51.20.61.70:3000/sales_forget_password/",data=request.POST)
        print(response)
        print(response.status_code)
        print(type(jsondec.decode(response.text)))
        print(jsondec.decode(response.text))
  ...
  #  if value != None:
   ...
   # else:
    ...
    if request.method == "POST":
        ...
        print(data)
        response = requests.post(f"http://51.20.61.70:3000/sales_forget_password_otp/{id}", data=data)
