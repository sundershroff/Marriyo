...
@api_view(['GET'])
def emra_coin_country(request,id):
    try:
        if request.method == 'GET':
            allDataa = emra_coin.objects.filter(country = "India")
            print(allDataa.values())
            # alldataserializer = serializer.emra_coin_all_Serializer(allDataa,many=True)
            return Response(data=allDataa.values(), status=status.HTTP_200_OK)
...
@api_view(['GET','POST'])
def dropdownn(request,id):
    try:
        if request.method == "GET":
            data = dropdown.objects.filter(category = id).values()
        ...
        if request.method == "POST":
            ...
            if 'category' in request.POST:
                if request.POST['category'] == "country":
                    data = dropdown.objects.create(
                        country = request.POST['country'],
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "currency":
                    data = dropdown.objects.create(
                        country = request.POST['country'],
                        cities = "None",
                        currency = request.POST['currency'],
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "marital_status":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "physical_status":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "cast":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "type_of_relationship":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "education":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "job_position":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "salary_range":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "intrest":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "no_intrest":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "complexion":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "food_taste":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "organs":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                    ...
                    print(data)
                    data.save()
                elif request.POST['category'] == "familystatus":
                    data = dropdown.objects.create(
                        country = "None",
                        cities = "None",
                        currency = "None",
                ...
                data = dropdown.objects.get(id = dele)
                data.delete()
            
            elif 'edit_cities' in request.POST:
                print("edit_cities")
                data = dropdown.objects.get(id = request.POST['add_city'])
                print(data)
                city = jsondec.decode(data.cities)
                add_city = json.dumps(city + request.POST.getlist("edit_cities"))
                print(add_city)
            elif 'delete_cities' in request.POST:
                print("delete_cities")
                dele = request.POST['id']
                inddex_value = request.POST['cityvalue']
                data = dropdown.objects.get(id = dele)
                value = jsondec.decode(data.cities)
                value.pop(int(inddex_value))
                data.cities = json.dumps(value)
                data.save()
                

            elif 'edit' in request.POST:
                data = dropdown.objects.get(id = request.POST['edit'])
                data.values = request.POST['values']
                data.save()
            
            elif 'currency_country' in request.POST:
                data = dropdown.objects.get(id = request.POST['currency_currency'])
                data.country = request.POST['currency_country']
                data.currency = request.POST['currency']
                data.save()
...
def dropdownn_cities_delete(request,id):
    try:
        if request.method == "POST":
            print("APIIIIIIIIIIIIIIIIIIi")
            print(request.POST)
